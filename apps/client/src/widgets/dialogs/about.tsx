            ...
            <table className="table table-borderless">
                <tbody>
                    <tr>
                        ...
                        <td><a className="tn-link external" href="https://github.com/SkySwimmer/Trilium" style={forceWordBreak}>https://github.com/SkySwimmer/Trilium</a></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            {appInfo?.buildRevision && <a className="tn-link build-revision external" href={`https://github.com/SkySwimmer/Trilium/commit/${appInfo.buildRevision}`} target="_blank" style={forceWordBreak}>{appInfo.buildRevision}</a>}
                        </td>
                    </tr>
                    <tr>
